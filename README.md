...
brain/               State/activity logs used by the content pipeline
...
- Check `brain/activity.log` for the pipeline's run history.
- `brain/news_state.json` tracks already-published news items; delete an
